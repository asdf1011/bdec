...
class OutlineView(tools.bgui.tool.service.ServiceView):
    ...
    def __init__(self, service):
        tools.bgui.tool.service.ServiceView.__init__(self, service)
...
class OutlineService(tools.bgui.tool.service.Service):
    ...
    def OnCloseFrame(self, event):
        tools.bgui.tool.service.Service.OnCloseFrame(self, event)
