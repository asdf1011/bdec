...
#
# Created:      9/2/04
# CVS-ID:       $Id: MessageService.py,v 1.3 2006/04/20 06:25:59 RD Exp $
...
class MessageView(tools.bgui.tool.service.ServiceView):
    ...
    def _CreateControl(self, parent, id):
        txtCtrl = tools.bgui.tool.texteditor.TextCtrl(parent, id)
...
class MessageService(tools.bgui.tool.service.Service):
