...
#
# Created:      10/6/03
# CVS-ID:       $Id: MarkerService.py,v 1.2 2006/04/20 06:25:59 RD Exp $
...
class MarkerService(wx.lib.pydocview.DocService):
    ...
    def InstallControls(self, frame, menuBar = None, toolBar = None, statusBar = None, document = None):
        if document and document.GetDocumentTemplate().GetDocumentType() != tools.bgui.tool.texteditor.TextDocument:
            return
